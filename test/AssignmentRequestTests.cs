...
#pragma warning disable CA2007 // Consider calling ConfigureAwait on the awaited task
	...
	public class AssignmentRequestTests
	{
		...
		public AssignmentRequestTests(ITestOutputHelper output)
		{
			this.output = output;
		}
        ...
        */
		...
		{
			// ARRANGE
			var responseContent = ResourceManager.GetHttpResponseContent("GetAssignmentsResponse.json");
